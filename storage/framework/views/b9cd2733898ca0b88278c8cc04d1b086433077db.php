...
<?php $__env->startSection('block-header', 'Suppliers'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <a href="<?php echo e(route('supplier.create')); ?>" class="btn btn-success">Add New Supplier</a>
                </div>
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable js-exportable">
                            ...
                            <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary waves-effect" href="<?php echo e(route('supplier.edit', $supplier->id)); ?>">
                                            <i class="material-icons">mode_edit</i>
                                        </a>
                                        <form style="display: inline;" action="<?php echo e(route('supplier.destroy', $supplier->id)); ?>" method="post" onsubmit="return confirm('Are you sure you want to delete <?php echo e($supplier->name); ?>');">
